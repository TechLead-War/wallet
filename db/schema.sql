...
CREATE TABLE public.users (
    id integer NOT NULL,
    customer_xid character varying(50) NOT NULL,
...
CREATE TABLE public.wallet (
    ...
    amount integer,
    customer_xid character varying(50) NOT NULL,
    enabled_at time without time zone,
...
--
-- Name: users users_customer_xid_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.users
    ADD CONSTRAINT users_customer_xid_key UNIQUE (customer_xid);
...
--
-- Name: wallet wallet_customer_xid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.wallet
    ADD CONSTRAINT wallet_customer_xid_fkey FOREIGN KEY (customer_xid) REFERENCES public.users(customer_xid);
